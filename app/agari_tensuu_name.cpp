...
bool is_ryoukei(agari_tensuu_name x){
  switch (x) {
    ...
    case agari_tensuu_name::fulo_4_han_ryoukei: return true;
    case agari_tensuu_name::fulo_6_han_ryoukei: return true;
    ...
    case agari_tensuu_name::fulo_4_han_gukei: return false;
    case agari_tensuu_name::fulo_6_han_gukei: return false;
...
bool is_fulo(agari_tensuu_name x){
  switch (x) {
    ...
    case agari_tensuu_name::fulo_4_han_gukei: return true;
    case agari_tensuu_name::fulo_6_han_gukei: return true;
    case agari_tensuu_name::menzen_1_han_gukei: return false;
    case agari_tensuu_name::menzen_1p7_han_gukei: return false;
    case agari_tensuu_name::menzen_2_han_gukei: return false;
    case agari_tensuu_name::menzen_alpha_han_gukei: return false;
...
float raw_han(agari_tensuu_name x){
  switch (x) {
    ...
    case agari_tensuu_name::fulo_4_han_ryoukei: return 4;
    case agari_tensuu_name::fulo_6_han_ryoukei: return 6;
    ...
    case agari_tensuu_name::fulo_4_han_gukei: return 4;
    case agari_tensuu_name::fulo_6_han_gukei: return 6;
...
std::string to_string(agari_tensuu_name x){
  switch(x){
    ...
    case agari_tensuu_name::fulo_4_han_ryoukei: return "F4良";
    case agari_tensuu_name::fulo_6_han_ryoukei: return "F6良";
    ...
    case agari_tensuu_name::fulo_4_han_gukei: return "F4愚";
    case agari_tensuu_name::fulo_6_han_gukei: return "F6愚";
